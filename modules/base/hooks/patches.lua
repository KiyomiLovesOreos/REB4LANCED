...
-- Obelisk, Onyx Agate, Rough Gem: handled via take_ownership in their respective module files.
-- These must use numeric values for config.extra to maintain compatibility with vanilla calculate and other mods.
