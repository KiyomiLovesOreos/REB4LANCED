...
if not REB4LANCED.config.all_seeing_eye_deck then return end

-- Scry helper functions (compatible with Pokermon's scry system; if Pokermon is
-- also installed its lovely patches already define these globals and ours are no-ops).
